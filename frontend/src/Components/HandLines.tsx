...
type landmarkData = {
    landMarkData: React.RefObject<handLandmarkData>,
}
        ...
        <>
            {[...Array(20)].map((_, index) => {
                if (stateLandMarkData) {
                    ...
                    const y = -(stateLandMarkData["landmarks"][index][1] - 720/2) / (720/2) + 1
                    const z = stateLandMarkData["landmarks"][index][2] / 200

                    const nextX = -(stateLandMarkData["landmarks"][index+1][0] - 1280/2) / (1280/2) * 3
                    const nextY = -(stateLandMarkData["landmarks"][index+1][1] - 720/2) / (720/2) +1
                    ...
                    if (index == 0) {
                        return ( <> 
                            ...
                            <Line points={[[x,y,z], [
                                ...
                                -(stateLandMarkData["landmarks"][index+1][1] - 720/2) / (720/2) +1,
                    ...
                    if (index == 5 || index == 9 || index == 13 ) {
                        return ( <> 
                            ...
                            <Line points={[[x,y,z], [
                                ...
                                -(stateLandMarkData["landmarks"][index+4][1] - 720/2) / (720/2) +1,
